...
const shorthandAliases: $ReadOnly<{
  ...
  scrollMargin: createSpecificTransformer('scroll-margin'),
  scrollPadding: createSpecificTransformer('scroll-padding'),
  inset: createDirectionalTransformer('inset', 'Block', 'Inline'),
